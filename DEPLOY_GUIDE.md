...
## Step 4 (recommended) -- Persistent backup that survives restarts
...
6. Save. The app will restart automatically. Open **⚙️ Settings** in the
   app -- you should see "Persistent backup enabled (GitHub Gist)".
