...
you can add vocab, scenarios, stories, quests, and badges without touching
any engine code. See README "Customization Tips".
...
LEVEL_UNLOCKS = {
    3: "'Ocean' theme unlocked 🌊",
    5: "'Autumn' theme unlocked 🍁",
    7: "Special avatar unlocked 🐸",
    10: "'Aurora' theme unlocked 🌅",
    12: "Special avatar unlocked 🦄",
}
...
GRAMMAR_TIPS = {
    "A1": [
        ("Avoir vs. être", "Lots of expressions use AVOIR (to have) in French where English uses 'to be': "
                            "j'ai faim (I am hungry), j'ai froid (I am cold), j'ai 25 ans (I am 25)."),
        ("Noun gender", "Every noun has a gender: masculine (le/un) or feminine (la/une). "
                               "E.g.: le café (m), la famille (f). It sinks in gradually -- no need to stress!"),
    ],
    "A2": [
        ("Passé composé (past tense)", "The passé composé is formed with avoir/être + past participle: "
                              "j'ai mangé (I ate), je suis allé(e) (I went). Most verbs use AVOIR."),
        ("Reflexive verbs", "Se réveiller (to wake up), se coucher (to go to bed), s'habiller (to get dressed)... "
                                    "add a reflexive pronoun: je me réveille, tu te réveilles, il/elle se réveille."),
    ],
    "B1": [
        ("Subjunctive (intro)", "After 'il faut que' (it's necessary that) or 'je veux que' (I want), the verb "
                                   "changes form: il faut que tu FASSES tes devoirs (not 'fais')."),
        ("Quebec French", "In Quebec, people often say 'magasiner' (to shop) or "
                                   "'un dépanneur' (convenience store) -- same language, different flavor!"),
    ],
    "B2": [
        ("Shades of opinion", "Varying 'je pense que' (I think that) with 'il me semble que' (it seems to me), "
                                   "'à mon sens' (in my view), 'd'un point de vue personnel' (from a personal "
                                   "standpoint) makes your speech richer and more nuanced."),
    ],
    "C1": [
        ("Registers of language", "French has very distinct registers: casual ('bouffer' -- to chow down), "
                                 "everyday ('manger' -- to eat), formal ('se restaurer' -- to dine). Choosing the "
                                 "right register for the context is an advanced skill."),
    ],
}
...
SCENARIOS = {
    "cafe": {
        "title": "At the Cafe ☕",
        "cefr": "A1",
        "description": "Order a coffee (and a croissant!) at a Parisian cafe.",
    ...
    "directions": {
        ...
        "cefr": "A2",
        "description": "You're lost in Old Quebec and ask for directions.",
    ...
    "meeting_friend": {
        ...
        "cefr": "B1",
        "description": "You meet up with a friend you haven't seen in a long time.",
...
# ---------------------------------------------------------------------------
QUESTS_DAILY = [
    {"id": "d1", "title": "Say hello!", "desc": "Send 5 messages to the tutor in French today.",
     "type": "chat_count", "target": 5, "xp": 20, "coins": 5},
    {"id": "d2", "title": "Describe your day", "desc": "Write 10 sentences about your day in the chat.",
     "type": "chat_count", "target": 10, "xp": 30, "coins": 8},
    {"id": "d3", "title": "Morning coffee", "desc": "Finish the \"At the Cafe\" role-play.",
     "type": "scenario", "target": "cafe", "xp": 25, "coins": 6},
    {"id": "d4", "title": "Quick review", "desc": "Review 10 vocabulary cards.",
     "type": "vocab_review", "target": 10, "xp": 20, "coins": 5},
    {"id": "d5", "title": "Next chapter", "desc": "Continue a chapter in Story Mode.",
     "type": "story", "target": 1, "xp": 25, "coins": 6},
]

QUESTS_WEEKLY = [
    {"id": "w1", "title": "Immersion week", "desc": "Practice 5 days this week (streak).",
     "type": "active_days", "target": 5, "xp": 100, "coins": 25},
    {"id": "w2", "title": "Quebec explorer", "desc": "Learn all 4 vocabulary words in the Quebec theme.",
     "type": "vocab_theme", "target": 4, "xp": 90, "coins": 20},
    {"id": "w3", "title": "Dialogue master", "desc": "Complete 3 different role-plays.",
...
# ---------------------------------------------------------------------------
BADGES = [
    {"id": "first_message", "name": "First Step", "emoji": "👣", "desc": "Send your first message in French."},
    {"id": "streak_3", "name": "Momentum", "emoji": "🔥", "desc": "Reach a 3-day streak."},
    {"id": "streak_7", "name": "Streak Master", "emoji": "🔥🔥", "desc": "Reach a 7-day streak."},
    {"id": "streak_30", "name": "Total Immersion", "emoji": "🔥🔥🔥", "desc": "Reach a 30-day streak."},
    {"id": "first_hour", "name": "First Immersion Hour", "emoji": "⏳", "desc": "Send 60 messages total."},
    {"id": "quebec_explorer", "name": "Quebec Explorer", "emoji": "🍁", "desc": "Learn every word in the Quebec theme."},
    {"id": "cafe_master", "name": "Cafe Regular", "emoji": "☕", "desc": "Finish the 'At the Cafe' role-play."},
    {"id": "scenario_5", "name": "Actor", "emoji": "🎭", "desc": "Finish every available role-play scene."},
    {"id": "storyteller", "name": "Storyteller", "emoji": "📖", "desc": "Finish a complete story."},
    {"id": "vocab_50", "name": "Word Collector", "emoji": "🧠", "desc": "Learn 20 vocabulary words."},
    {"id": "vocab_100", "name": "Budding Polyglot", "emoji": "📚", "desc": "Learn 30 vocabulary words."},
    {"id": "level_5", "name": "Level 5", "emoji": "⭐", "desc": "Reach game level 5."},
    {"id": "level_10", "name": "Level 10", "emoji": "🌟", "desc": "Reach game level 10."},
    {"id": "corrector", "name": "Grammar Apprentice", "emoji": "✏️", "desc": "Receive 20 friendly corrections -- mistakes are part of learning!"},
]
